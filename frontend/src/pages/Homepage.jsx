...
const featureItems = [
  {
    ...
    description: 'Our advanced machine learning models analyze real-time market data, historical trends, and seasonal factors to provide you with the most accurate price predictions for your agricultural produce.',
    iconUrl: 'https://placehold.co/100x100/34d399/ffffff?text=Price'
  },
  {
    title: 'Connect with Buyers',
    description: 'Say goodbye to middlemen. Our platform is a vibrant marketplace where you can connect directly with verified buyers.',
    iconUrl: 'https://placehold.co/100x100/34d399/ffffff?text=Connect'
  }
];
...
const Homepage = () => {
  ...
  return (
    <div className="font-sans bg-white text-slate-800">
      {/* Header */}
      <header className="bg-green-800 shadow-md fixed top-0 left-0 w-full z-20">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-white">AgriPredict AI</h1>
          <div className="flex items-center space-x-4">
            <Link to="/login" className="text-white hover:text-green-200 font-medium">Log In</Link>
            <Link to="/register" className="text-white hover:text-green-200 font-medium">Registration</Link>
            <a href="#about-us-section" className="text-white hover:text-green-200 font-medium">About Us</a>
          </div>
        </div>
      </header>
        ...
        >
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-3xl mx-auto">
              Enhancing farmer-buyer efficiency through agricultural price prediction using machine learning.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {featureItems.map((item, index) => (
                <div key={index} className="p-6 bg-gray-50 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow">
                  <img src={item.iconUrl} alt={item.title} className="mx-auto mb-4 rounded-full" />
        ...
        <section id="about-us-section" className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="prose max-w-none space-y-8">
              <p>AgriPredict AI is dedicated to empowering farmers and buyers by bridging the gap in agricultural market information...</p>
              <h3 className="text-2xl font-bold text-green-700 mt-8 mb-4">Our Mission</h3>
              <p>Our mission is to create a more stable and prosperous ecosystem for the agricultural sector...</p>
              <h3 className="text-2xl font-bold text-green-700 mt-8 mb-4">Our Vision</h3>
              <p>We envision a future where every farmer has access to real-time, accurate market data...</p>
              <h3 className="text-2xl font-bold text-green-700 mt-8 mb-4">Our Commitment</h3>
              <p>We are committed to ethical data practices and continuous innovation...</p>
            </div>
          </div>
        </section>
      </main>
